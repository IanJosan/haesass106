    ...
    <el-dialog :visible="showDialog" :title="showText" @close="btnCancel">
      <el-form ref="perForm" label-width="120px" :model="formData" :rules="rules">
        <el-form-item label="名称" prop="name">
          <el-input v-model="formData.name" title="" style="width:90%;" />
        </el-form-item>
        <el-form-item label="标识" prop="code">
          <el-input v-model="formData.code" title="" style="width:90%;" />
        </el-form-item>
        <el-form-item v-model="formData.description" label="描述">
          <el-input title="" style="width:90%;" />
        </el-form-item>
        <el-form-item v-model="formData.enVisible" label="启用">
